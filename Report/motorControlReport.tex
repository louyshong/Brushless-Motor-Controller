...
\centering                      % used for centering table
\begin{tabular}{c c c c}        % centered columns (4 columns)
Task & Initiation Interval (t) & Execution Time (T) & Task Utilization (U) \\ [0.5ex]   % inserts table %heading
\hline                          % inserts 1 horizontal line
Motor ISR & 1.28ms & 5.0us & 0.40\% \\           % table contents
Output & 1.0s & 101ms & 10.11\% \\
Motor Control & 100ms & 75us  & 0.08\% \\
Decode & 93.75ms & 53us & 0.0565\% \\
BitCoin Mining & 1.0s & 868ms & 86.8\% \\
Melody & 0.125s & 1.0us & 0.0008\% \\[1ex]     % [1ex] adds vertical space
\end{tabular}
